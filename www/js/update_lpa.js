...
function assignValues(){
	...
	for(b=0;b<activity_arr.length;b++){
		...
		var div_val = '<div class="ui-grid-c vgb" id="up_checkbox'+c+'"><div class="ui-block-a "><div class="ui-grid-a"><div class="ui-block-a radi"><label class="flo">Yes:</label></div><div class="ui-block-b"><input type="radio" id="up_result_yes_a'+c+'" name="up_result_yes'+c+'"  value="yes" ></div></div></div><div class="ui-block-b"><div class="ui-grid-a"><div class="ui-block-a radi"><label class="flo">No:</label></div><div class="ui-block-b radi"><input type="radio" id="up_result_yes_b'+c+'" name="up_result_yes'+c+'" value="no" class="marl"><br id="up_result_no_br'+c+'"></div></div></div><div class="ui-block-c "><div class="ui-grid-a"><div class="ui-block-a radiu"><label class="flo">N/A:</label ></div><div class="ui-block-b radi"><input type="radio" id="up_result_yes_c'+c+'" name="up_result_yes'+c+'" value="na"></div></div></div><div class="ui-block-d"><a href="#" class="ui-btn pls ui-shadow ui-corner-all ui-icon-plus ui-btn-icon-notext"  id="up_add'+c+'" onclick="showfields('+c+');">up_add</a><a href="#" id="up_minus'+c+'" class="ui-btn pls ui-shadow ui-corner-all ui-icon-minus ui-btn-icon-notext" style="display:none" onclick="hidefields('+c+');" >up_minus</a><br id="up_up_result_na_br'+c+'" style="display:none;"></div></div><div class="paf"><input type="text"   id="up_findings'+c+'" class="dar" name="up_findings'+c+'" value="'+activityobj.findings+'" placeholder="Findings" style="display:none;"><select name="up_responsibility'+c+'" id="up_responsibility'+c+'" ><option value="0">Choose Responsibility</option><option value="supervisor">Supervisor</option><option value="Manager">Manager</option><option value="GM">GM</option></select><div class="demo"><input type="text" style="display:none;"  id="up_datepicker'+c+'" class="dar" placeholder="Date" name="up_datepicker'+c+'" value="'+activityobj.closed_date+'"/></div></div>';
